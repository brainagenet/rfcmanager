...
public class PreferencesDialog extends Dialog
{
    ...
    private void createContents() {
        ...
        this.shell.setImage(SWTResourceManager.getImage(PreferencesDialog.class, "/icons/config_obj.gif"));
        ...
        this.svnProtocolCombo.setItems(new String[] {"http://", "https://", "svn://", "svn+xxx:///", "file://"});
